...
class movie{
   ...
   let Movie1=new movie("Avatar","aaa")
   Movie1.display()
  let Movie2=new movie("Estate","xxxx","PG")
  let Movie3=new movie("Fast&furious ","yyy","PG")
  let Movie4=new movie("Sky Sharks","xxxx","PG")
  let film=new movie("The meg","zzzz","PG13")
 film.display()
  let arr=[]
...
let Person1=new Person("Rajakumar","5.9","61","25","green","B.E","Dharmapuri","Tamilnadu")
Person1.details()
